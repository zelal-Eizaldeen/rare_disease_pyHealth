...
class LocalLLMClient:
    ...
    def query(self, user_input, system_message):
        ...
        terminators = [
            ...
            self.pipeline.tokenizer.convert_tokens_to_ids("<|endoftext|>"), #Zilal
            self.pipeline.tokenizer.convert_tokens_to_ids("<|im_end|>")#Zilal
        ]
        #added by Zilal
    ...
    def batched_query(self, user_inputs, system_messages, max_batch_size=None):
        ...
        for i in range(num_batches):
            ...
            terminators = [
                ...
                tokenizer.convert_tokens_to_ids("<|endoftext|>"), #Zilal
                tokenizer.convert_tokens_to_ids("<|im_end|>")#Zilal
            ]
            #Added by Zilal
            # keep only valid ints
            terminators = [t for t in terminators if isinstance(t, int) and t >= 0]
...
class VLLMClient:
    ...
    MODEL_MAPPING = {
        ...
        "qwen3_32b": "Qwen/Qwen3-32B", #By Zilal
